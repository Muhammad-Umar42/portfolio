            ...
            <div className="static-hero-right">
                <div className="static-hero-img">
                    <div className="static-hero-img-inner">
                        <img src='images/portfolio.png' alt="umar-portfolio" />
                        <div className="icon-1 floating-item"><img src='images/icon/react.png' alt="reactJs" /></div>
                        <div className="icon-2 floating-item"><img src='images/icon/mongo.png' alt="mongodb" /></div>
                        <div className="icon-3 floating-item"><img src='images/icon/tailwind.png' alt="tailwingcss" /></div>
